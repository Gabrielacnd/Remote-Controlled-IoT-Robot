...
// Funcție pentru procesarea comenzilor și trimiterea lor către Arduino Uno
void processCarMovement(String inputValue)
{
  Serial.println(inputValue); // Trimite comanda către Arduino Uno prin Serial
}
...
void setup(void) 
{
  Serial.begin(9600); // Comunicare serială cu Arduino Uno
